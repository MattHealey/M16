...
levels(lb$eth)  <- list("Maori" = "Maori", "European or other" = c("European", "Asian"), "Pacific" = "Pacific", "Total" = "Total", "Unknown" = "Unknown")
...
#lb <- droplevels(lb); c01 <- droplevels(c01); c06 <- droplevels(c06); c13 <- droplevels(c13)
# 4 levels (incl total)
#lb   "Maori"             "European or other" "Pacific"           "Total"
#2001 "Maori"             "European or other" "Pacific"           "Total"
#2006 "Maori"             "European or other" "Pacific"           "Total"
#2013 "Maori"             "European or other" "Pacific"           "Total"
# now eth does!
#
